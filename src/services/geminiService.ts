...
export async function analyzeMessage(
  ...
  const selectedModel = typeof window !== 'undefined' ? (localStorage.getItem("phishguard_gemini_model") || "gemini-2.5-flash-lite") : "gemini-2.5-flash-lite";
  const modelsToTry = Array.from(new Set([selectedModel, "gemini-2.5-flash-lite", "gemini-2.5-flash", "gemini-2.0-flash", "gemini-1.5-flash", "gemini-1.5-flash-8b", "gemini-1.5-pro"]));
